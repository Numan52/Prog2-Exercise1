...
public class WatchlistMovieCell extends ListCell<WatchlistMovieEntity> {
    ...
    private final Button removeMovieBtn = new Button();
    ...
    private final VBox layout = new VBox(title, description, genres, removeMovieBtn);
    ...
    protected void updateItem(WatchlistMovieEntity movie, boolean empty) {
        ...
        if (empty || movie == null) {
            ...
            removeMovieBtn.getStyleClass().add("background-yellow");
